...
exports.makePlacesTypescriptFile = exports.makePlaceTypescriptFile = void 0;
const segmentsInfo = {
    start: {
        name: "start",
        duration: 1.0,
...
function makePlaceTypescriptFile(placeInfo) {
...
exports.makePlaceTypescriptFile = makePlaceTypescriptFile;
// fs.writeFileSync(`${grandparent_folder_path}${os.sep}places.ts`, () => {
function makePlacesTypescriptFile(placeNames) {
...
exports.makePlacesTypescriptFile = makePlacesTypescriptFile;
